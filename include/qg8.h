...
#define QG8_TYPE_ADJACENCY         0
#define QG8_TYPE_INPUT             1
#define QG8_TYPE_CONSTANT          2
#define QG8_TYPE_KET               3
#define QG8_TYPE_OPERATOR          4
#define QG8_TYPE_OBSERVABLE        5
#define QG8_TYPE_TIME              6
#define QG8_TYPE_NOISESPEC         7
#define QG8_TYPE_ADD               8
#define QG8_TYPE_SUBTRACT          9
#define QG8_TYPE_MATMUL            10
#define QG8_TYPE_JOIN              11
#define QG8_TYPE_SOLVE             12
#define QG8_TYPE_EXPECTATIONVALUE  13
#define QG8_TYPE_SAMPLE            14
#define QG8_TYPE_TRACK             15
